    ...
    <nav class="h-100">
      <div class="container h-100">
        ...
        >
          ...
          >
            <li>
              <RouterLink to="/products" class="fs-5">產品一覽</RouterLink>
            </li>
            <li><RouterLink to="/about" class="fs-5">關於我們</RouterLink></li>

            <li>
              <RouterLink to="/articles" class="fs-5">好文分享</RouterLink>
            </li>
            <li>
              <RouterLink to="/login" class="fs-5">登入</RouterLink>
            </li>
            <li>
              <a href="" @click.prevent="" class="cartIcon"
    ...
    <div class="container">
      ...
      >
        <div class="d-flex justify-content-center flex-wrap gap-5">
          <router-link to="/products" class="text-white fs-lg-5 fs-md-6"
            >產品一覽</router-link
          >
          <router-link to="/about" class="text-white fs-lg-5 fs-md-6"
            >關於我們</router-link
          >
          <router-link to="/" class="text-white fs-lg-5 fs-md-6"
            >好文分享</router-link
          >
        </div>
